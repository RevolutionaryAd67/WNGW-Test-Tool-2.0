...
class IEC104ServerStack:
    ...
    def register_event_bus(
        self, event_bus: EventBus, loop: asyncio.AbstractEventLoop, channel: str = "server"
    ) -> None:
    ...
    def receive_frame(self, frame: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self._publish_frame_event("incoming", incoming)
        response = {
            "type": "S",
